...
class CompleteOrderValidator extends BaseValidator
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'order.cpf' => ['nullable', 'string', 'max:20'],
            'order.blood_type' => ['nullable', 'string', 'max:3'],
            'order.emergency_contact_name' => ['nullable', 'string', 'max:100'],
            'order.emergency_contact_phone' => ['nullable', 'string', 'max:30'],
            'products.*.cpf' => ['nullable', 'string', 'max:20'],
            'products.*.blood_type' => ['nullable', 'string', 'max:3'],
            'products.*.emergency_contact_name' => ['nullable', 'string', 'max:100'],
            'products.*.emergency_contact_phone' => ['nullable', 'string', 'max:30'],
