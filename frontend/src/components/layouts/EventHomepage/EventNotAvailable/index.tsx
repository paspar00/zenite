...
export const EventNotAvailable = () => {
    return (
        <GenericErrorPage
            ...
            buttonText={isOrbitaTickets() ? t`Create your own event` : undefined}
            buttonUrl={isOrbitaTickets() ? "https://app.orbitasports.com/auth/register?utm_source=app.orbitasports.com&utm_content=organizer-not-found/create-event" : undefined}
